...
{				 // metodo que permite insertar nuevos nodos al inicio de la lista, el segundo sería el que estaba anteriormente primero 
...
{			   // metodo que permite insertar nuevos nodos ordenadamente en la lista
	...
	{							  // la lista contiene nodos anteriores
		...
		{ // recorrido mientras el nodo apuntado no apunta a null
			ant = act;
			act = act->getPunt(); // actualizar apuntador de recorrido// si es menor avanza al siguiente dirección de memoria 4<3 avanaza 
		}
