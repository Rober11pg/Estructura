...
Determinar si una cola A esta completamente contenida en una cola B*/
...
int main()
{
    ...
    cout << "Si todos los elementos de la cola A " << ((estaIncluida(a, b)) ? " SI" : " NO ") << " se ecuentran contenidos en la cola B..." << endl;
    system("pause");
}
