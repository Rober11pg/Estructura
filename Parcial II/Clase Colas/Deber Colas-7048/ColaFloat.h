...
typedef float Tipo; // Definir el tipo de datos del TDA
#define EXT 20    // cantidad maxima de elementos del TDA

class ColaFloat // definicion del TDA
{
...
ColaFloat ::ColaFloat() // constructor
{
...
void ColaFloat ::insertar(Tipo v)
{
