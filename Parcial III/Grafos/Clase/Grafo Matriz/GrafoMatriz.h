...
typedef int * pint; 							//para el dimensionamiento de la matriz // apuntador a enteros
...
private:										//definición de atributos
	...
	int** matAd; 								//matriz de adyacencia //matriz dinámica 
...
GrafoMatriz::GrafoMatriz() {						//constructor por defecto (sin parámetros)
	setMaxVerts(1);									//cantidad maxima de vertices por defecto (por lo menos debe tener un 1)
