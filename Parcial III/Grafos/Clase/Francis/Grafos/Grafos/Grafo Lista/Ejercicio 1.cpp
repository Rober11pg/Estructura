/* Dado un grafo obtener los vertices, y sus conexiones en un vector de listas, 
sumar los vertices por cada conexion que tenga y averiguar el mayor de los números ingresados */
...
int main(){
	...
	n = leerN(1,10);							//lectura de cantidad de vertices del grafo
	cin.ignore();
