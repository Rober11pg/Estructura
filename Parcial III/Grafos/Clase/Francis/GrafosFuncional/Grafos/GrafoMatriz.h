...
public:												//métodos públicos
    ...
    //para guardar valores en el vector de vertices
    ...
    //para guardar valores en la matrtiz de adyacencia
    void setArco(int va, int vb);					//actualiza valor de arco recibiendo numeros de vertices en grafo no valorados
	void setArco(int va, int vb, int v);			//actualiza valor de arco recibiendo numeros de vertices, con grafs valorados o con peso
	void setArco(Tipo a, Tipo b);					//actualiza valor de arco recibiendo nombres de vertices en grafos no valorados
	void setArco(Tipo a, Tipo b, int v);			//actualiza valor de arco recibiendo nombres de vertices,  con grafs valorados o con peso
